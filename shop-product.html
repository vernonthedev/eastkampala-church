...
<div class="body"> 
  ...
  <div class="nav-backed-header parallax" style="background-image:url(http://placehold.it/1280x635&amp;text=IMAGE+PLACEHOLDER.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
        ...
        <div class="row">
        	<div class="col-md-9">
            	<div class="single-product">
                	<div class="row">
                    	<div class="col-md-5">
                        	<a href="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER.jpg" data-rel="prettyPhoto[pro gallery]"><img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER.jpg" alt="" class="img-thumbnail"></a>
                        ...
                        <div class="col-md-7">
                        	<h2>Product 1</h2>
                            <p class="accent-color lead">$340</p>
                            ...
                            <p>Categories: <a href="#">Creative</a>, <a href="#">Design</a>, <a href="#">Hand Made</a>, <a href="#">wood</a></p>
                        </div>
                  	</div>
                    <div class="spacer-30"></div>
                    <div class="tabs">
                      ...
                      <li class="col-md-4 col-sm-6">
                          <div class="shop-item">
                              <div class="product-image">
                                  <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER.jpg" alt="">
                                  <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                              </div>
                              <div class="product-details">
                                  <h3><a href="#">Product 1</a></h3>
                                  <span class="product-categories"><a href="#">Wallpaper</a></span>
                              </div>
                      ...
                      <li class="col-md-4 col-sm-6">
                          <div class="shop-item">
                              <div class="product-image">
                                  <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER.jpg" alt="">
                                  <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                                  <span class="shop-badge label-danger">Hot</span>
                              </div>
                              <div class="product-details">
                      ...
                      <li class="col-md-4 col-sm-6">
                          <div class="shop-item">
                              <div class="product-image">
                                  <img src="http://placehold.it/600x400&amp;text=IMAGE+PLACEHOLDER.jpg" alt="">
                                  <a href="#" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a>
                                  <span class="shop-badge label-success">Sale</span>
                              </div>
                              <div class="product-details">
