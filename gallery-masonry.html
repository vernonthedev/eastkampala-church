          ...
          <div class="col-md-12">
            <ul class="grid-holder col-3 events-grid">
              <li class="grid-item post format-image">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" alt=""> </a> </div>
              </li>
              <li class="grid-item post format-image">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" alt=""> </a> </div>
              </li>
              ...
              <li class="grid-item post format-video">
                <div class="grid-item-inner"> <a href="https://vimeo.com/19564018" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/800x450&amp;text=IMAGE+PLACEHOLDER" alt=""> </a> </div>
              </li>
              <li class="grid-item post format-image">
                <div class="grid-item-inner"> <a href="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/600x600&amp;text=IMAGE+PLACEHOLDER" alt=""> </a> </div>
              </li>
              ...
              <li class="grid-item post format-video">
                <div class="grid-item-inner"> <a href="http://youtu.be/NEFfnbQlGo8" data-rel="prettyPhoto" class="media-box"> <img src="http://placehold.it/800x450&amp;text=IMAGE+PLACEHOLDER" alt=""> </a> </div>
              </li>
            </ul>
