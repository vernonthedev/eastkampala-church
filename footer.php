        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 widget footer-widget">
                ...
                <ul>
                    ...
                    <li><a href="devotions.php">Our Devotions</a></li>
                </ul>
            </div>
            <div class="col-md-4 col-sm-4 widget footer-widget">
    ...
    <div class="container">
        <div class="row">
            <div class="copyrights-col-left col-md-6 col-sm-6">
                <p>Copyright © <script>document.write(new Date().getFullYear())</script>. All Rights Reserved by East Kampala Seventh Day Adventist Church</p>
            </div>
